...
namespace Catlang.Client.Models
{
    ...
    {
        public SetView(Guid id, string authorName, string studyTopic, string wordsLine, int popularity, double efficiency, double averageStudyTime, double complexity)
        {
            Id = id;
